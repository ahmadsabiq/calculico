...
<html lang="en-us">
  ...
  <body>
    ...
    <script>
      ...
      var buildUrl = "sepatu/Build";
      var loaderUrl = buildUrl + "/Sepatu.loader.js";
      var config = {
        dataUrl: buildUrl + "/Sepatu.data.unityweb",
        frameworkUrl: buildUrl + "/Sepatu.framework.js.unityweb",
        codeUrl: buildUrl + "/Sepatu.wasm.unityweb",
