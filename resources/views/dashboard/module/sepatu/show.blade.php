...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-dark-subtle">
    <h1 class="h2">Modul Comparation</h1>
  </div>
  ...
  <div class="row w-100 ">
    ...
    <ul class="list-display list-checkmarks">
      <li>Anak sudah dapat mengidentifikasi warna primer (merah, kuning, biru)</li>
      <li>Anak sudah dapat mengidentifikasi dan membedakan sepatu dan sandal</li>
    </ul>
    </div>
    ...
    <div class="col shadow-sm m-3 p-4 bg-body-tertiary border rounded-3">
      ...
      <div class="col shadow-sm m-3 p-4 bg-body-tertiary border rounded-3">
        ...
        <ul class="list-display list-checkmarks">
          <li>Membandingkan (komparatif dan superlatif)</li>
          <li>Sense of size</li> 
  ...
  <div class="mt-3">
    <a href="/sepatu" class="w-100 btn btn-success">Latihan Sekarang</a>
</div>
